...
class Node:
	...
	def __eq__(self, __o: object) -> bool:
		if __o:
			return self.f_val == __o.f_val and self.block.x == __o.block.x and self.block.y == __o.block.y and (self.block.board == __o.block.board).all() and self.block.rotation == __o.block.rotation
		return False
